...
class DemoPanel(wx.Panel):
    ...
    def on_paint(self, event):
        ...
        if(self.BITMAP_FLAG == 0): 
           ...
           # temp_dc.BeginDrawing() 
            ...
            temp_dc.DrawRectangle(220, 10, 200, 200)
    ...
    def redraw_bitmap(self):
        self.bitmap1 = wx.StaticBitmap(self, -1, self.bitmap1, (0,0))
        self.bmp1 = wx.StaticBitmap(self, -1, self.bmp1, (0,0))
